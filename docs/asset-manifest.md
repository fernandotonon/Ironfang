...
The Enemy Fortress reuses the Clan Fortress model (rotated 180°, red team frame). Audio is
synthesized by `scripts/gen-audio.py` (17 WAVs, original). Machine-readable metadata for the
in-game showcase: `app/config/assetmeta.js` (`scripts/gen-asset-meta.py`).
...
| Orc Archer | Orc Archer.png | 9 918 | 10 539 | 4 × 1024² | 19-bone humanoid | Idle · Walk · Attack · Hit · Death | **runtime** (`assets/runtime/orc_archer/OrcArcher.qml`) | Orc Archer |
| Goblin | Goblin.png | 9 964 | 10 906 | 4 × 1024² | 19-bone humanoid | Idle · Walk · Attack · Hit · Death · **Gather** (`farmloop`) | **runtime** (`assets/runtime/goblin/Goblin.qml`) | Goblin Worker |
| Ogre | Ogre.png | 9 908 | 10 657 | 4 × 1024² | 19-bone humanoid | Idle · Walk · Attack · Hit · Death | **runtime** (`assets/runtime/ogre/Ogre.qml`) | Ironhide Ogre |

## Buildings and props

| Asset | Source image | Tris | Verts | Status | Intended use |
|---|---|---:|---:|---|---|
| Clan Fortress | Clan Fortress.png | 9 788 | 15 926 | **runtime** (`assets/runtime/clan_fortress/`) | Clan Fortress |
| War Foundry | War Foundry.png | 9 918 | 15 331 | **runtime** (`assets/runtime/war_foundry/`) | War Foundry |
| Iron Deposit | Iron Deposit.png | 9 994 | 11 554 | **runtime** (`assets/runtime/iron_deposit/`) | Iron Deposit |
...
| Broken Cart | Broken Cart.png | 9 866 | 13 482 | **runtime** (`assets/runtime/broken_cart/`) | map obstacle |
| Dead Ironwood tree | Dead Ironwood tree.png | 9 058 | 12 859 | **runtime** (`assets/runtime/dead_tree/`) | map obstacle |
| Large Rocks | Large Rocks.png | 9 998 | 8 988 | **runtime** (`assets/runtime/large_rocks/`) | map obstacle |
| Small Rocks | Small Rocks.png | 9 990 | 8 453 | **runtime** (`assets/runtime/small_rocks/`) | map decoration |
...
|---|---|---:|---:|---|
| Arrow | Arrow.png | 10 000 | 8 784 | **runtime** (`assets/runtime/arrow/`, archer projectile) |
